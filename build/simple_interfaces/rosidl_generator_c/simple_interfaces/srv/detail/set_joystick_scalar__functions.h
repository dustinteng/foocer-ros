...
#ifndef SIMPLE_INTERFACES__SRV__DETAIL__SET_JOYSTICK_SCALAR__FUNCTIONS_H_
#define SIMPLE_INTERFACES__SRV__DETAIL__SET_JOYSTICK_SCALAR__FUNCTIONS_H_
...
/// Initialize srv/SetJoystickScalar message.
/**
...
/// Finalize srv/SetJoystickScalar message.
/**
...
/// Create srv/SetJoystickScalar message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * simple_interfaces__srv__SetJoystickScalar_Request__init().
...
/// Destroy srv/SetJoystickScalar message.
/**
 * It calls
 * simple_interfaces__srv__SetJoystickScalar_Request__fini()
...
/// Check for srv/SetJoystickScalar message equality.
/**
...
/// Copy a srv/SetJoystickScalar message.
/**
...
/// Initialize array of srv/SetJoystickScalar messages.
/**
...
/// Finalize array of srv/SetJoystickScalar messages.
/**
 * It calls
 * simple_interfaces__srv__SetJoystickScalar_Request__fini()
...
/// Create array of srv/SetJoystickScalar messages.
/**
 * It allocates the memory for the array and calls
 * simple_interfaces__srv__SetJoystickScalar_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetJoystickScalar messages.
/**
 * It calls
 * simple_interfaces__srv__SetJoystickScalar_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetJoystickScalar message array equality.
/**
...
/// Copy an array of srv/SetJoystickScalar messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * simple_interfaces__srv__SetJoystickScalar_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_simple_interfaces
...
/**
 * It calls
 * simple_interfaces__srv__SetJoystickScalar_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_simple_interfaces
...
/**
 * It allocates the memory for the array and calls
 * simple_interfaces__srv__SetJoystickScalar_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_simple_interfaces
...
/**
 * It calls
 * simple_interfaces__srv__SetJoystickScalar_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SIMPLE_INTERFACES__SRV__DETAIL__SET_JOYSTICK_SCALAR__FUNCTIONS_H_
