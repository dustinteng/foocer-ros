...
class Metaclass_SetLed(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from simple_interfaces.srv import _set_led
...
class SetLed(metaclass=Metaclass_SetLed):
    from simple_interfaces.srv._set_led import SetLed_Request as Request
    from simple_interfaces.srv._set_led import SetLed_Response as Response
