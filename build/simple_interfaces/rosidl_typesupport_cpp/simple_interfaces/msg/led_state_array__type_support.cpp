...
static const _LedStateArray_type_support_symbol_names_t _LedStateArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_interfaces, msg, LedStateArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simple_interfaces, msg, LedStateArray)),
  }
};
...
get_message_type_support_handle<simple_interfaces::msg::LedStateArray>()
{
  return &::simple_interfaces::msg::rosidl_typesupport_cpp::LedStateArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, simple_interfaces, msg, LedStateArray)() {
  return get_message_type_support_handle<simple_interfaces::msg::LedStateArray>();
}
