...
static const _ExService_Request_type_support_symbol_names_t _ExService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_interfaces, srv, ExService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simple_interfaces, srv, ExService_Request)),
  }
};
...
{
  return &::simple_interfaces::srv::rosidl_typesupport_cpp::ExService_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, simple_interfaces, srv, ExService_Request)() {
  return get_message_type_support_handle<simple_interfaces::srv::ExService_Request>();
}
...
static const _ExService_Response_type_support_symbol_names_t _ExService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_interfaces, srv, ExService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simple_interfaces, srv, ExService_Response)),
  }
};
...
{
  return &::simple_interfaces::srv::rosidl_typesupport_cpp::ExService_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, simple_interfaces, srv, ExService_Response)() {
  return get_message_type_support_handle<simple_interfaces::srv::ExService_Response>();
}
...
static const _ExService_type_support_symbol_names_t _ExService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_interfaces, srv, ExService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simple_interfaces, srv, ExService)),
  }
};
...
{
  return &::simple_interfaces::srv::rosidl_typesupport_cpp::ExService_service_type_support_handle;
}
