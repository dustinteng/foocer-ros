...
#include "simple_interfaces/srv/detail/set_led__rosidl_typesupport_fastrtps_c.h"
...
using _SetLed_Request__ros_msg_type = simple_interfaces__srv__SetLed_Request;
...
size_t get_serialized_size_simple_interfaces__srv__SetLed_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetLed_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_simple_interfaces__srv__SetLed_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_simple_interfaces
size_t max_serialized_size_simple_interfaces__srv__SetLed_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SetLed_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_simple_interfaces__srv__SetLed_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, simple_interfaces, srv, SetLed_Request)() {
...
using _SetLed_Response__ros_msg_type = simple_interfaces__srv__SetLed_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_simple_interfaces
size_t get_serialized_size_simple_interfaces__srv__SetLed_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetLed_Response__ros_msg_type * ros_message = static_cast<const _SetLed_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_simple_interfaces__srv__SetLed_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_simple_interfaces
size_t max_serialized_size_simple_interfaces__srv__SetLed_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SetLed_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_simple_interfaces__srv__SetLed_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, simple_interfaces, srv, SetLed_Response)() {
...
// already included above
// #include "simple_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "simple_interfaces/srv/set_led.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, simple_interfaces, srv, SetLed)() {
