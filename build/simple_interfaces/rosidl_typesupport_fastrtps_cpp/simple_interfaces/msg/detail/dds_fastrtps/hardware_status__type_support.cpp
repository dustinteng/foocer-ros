...
#include "simple_interfaces/msg/detail/hardware_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const simple_interfaces::msg::HardwareStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  simple_interfaces::msg::HardwareStatus & ros_message)
{
  // Member: temperature
  cdr >> ros_message.temperature;
...
{
  auto typed_message =
    static_cast<const simple_interfaces::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<simple_interfaces::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  return &simple_interfaces::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_interfaces, msg, HardwareStatus)() {
  return &simple_interfaces::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
