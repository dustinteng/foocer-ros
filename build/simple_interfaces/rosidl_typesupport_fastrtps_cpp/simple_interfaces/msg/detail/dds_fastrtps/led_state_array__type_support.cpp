...
#include "simple_interfaces/msg/detail/led_state_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const simple_interfaces::msg::LedStateArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  simple_interfaces::msg::LedStateArray & ros_message)
{
  // Member: led_states
  {
    cdr >> ros_message.led_states;
...
{
  auto typed_message =
    static_cast<const simple_interfaces::msg::LedStateArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<simple_interfaces::msg::LedStateArray *>(
    untyped_ros_message);
...
{
  return &simple_interfaces::msg::typesupport_fastrtps_cpp::_LedStateArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_interfaces, msg, LedStateArray)() {
  return &simple_interfaces::msg::typesupport_fastrtps_cpp::_LedStateArray__handle;
}
