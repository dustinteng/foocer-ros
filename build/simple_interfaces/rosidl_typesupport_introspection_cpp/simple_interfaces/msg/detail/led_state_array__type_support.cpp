...
{
  new (message_memory) simple_interfaces::msg::LedStateArray(_init);
}

void LedStateArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<simple_interfaces::msg::LedStateArray *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LedStateArray_message_member_array[1] = {
  {
    ...
    offsetof(simple_interfaces::msg::LedStateArray, led_states),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LedStateArray_message_members = {
  ...
  1,  // number of fields
  sizeof(simple_interfaces::msg::LedStateArray),
...
{
  return &::simple_interfaces::msg::rosidl_typesupport_introspection_cpp::LedStateArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simple_interfaces, msg, LedStateArray)() {
  return &::simple_interfaces::msg::rosidl_typesupport_introspection_cpp::LedStateArray_message_type_support_handle;
}
